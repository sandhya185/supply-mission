...
function setup() {
	...
	box1=createSprite(405,470,200,20);
	box1.shapeColor="red";
	box2=createSprite(500,430,20,100);
	box2.shapeColor="red";
	box3=createSprite(300,430,20,100);
	box3.shapeColor="red";
	
	engine = Engine.create();
	world = engine.world;

	packageBody = Bodies.circle(width/2 , 430 , 5 , {restitution:3, isStatic:true});
	World.add(world, packageBody);
